...
void AccountSettings::Init()
{
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(_T("Settings"),_T("crashReport"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	crashReport=str==_T("0")?0:1;
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(_T("Settings"),_T("disableVP8"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	disableVP8 = str == "1" ? 1 : 0;
	ptr = bitrateVP8.GetBuffer(255);
	GetPrivateProfileString(_T("Settings"),_T("bitrateVP8"), NULL, ptr, 256, iniFile);
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(_T("Settings"),_T("contactsWidth0"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
	...
	ptr = str.GetBuffer(255);
	GetPrivateProfileString(_T("Settings"),_T("autoHangUpTime"), NULL, ptr, 256, iniFile);
	str.ReleaseBuffer();
...
void AccountSettings::SettingsSave()
{
	...
	WritePrivateProfileString(_T("Settings"),_T("crashReport"),crashReport?_T("1"):_T("0"),iniFile);
	...
	WritePrivateProfileString(_T("Settings"),_T("disableVP8"),disableVP8?_T("1"):_T("0"),iniFile);
	WritePrivateProfileString(_T("Settings"),_T("bitrateVP8"),bitrateVP8,iniFile);
#endif
	...
	WritePrivateProfileString(_T("Settings"),_T("contactsWidth0"),str,iniFile);
	...
	WritePrivateProfileString(_T("Settings"),_T("autoHangUpTime"),str,iniFile);
